...
def build_jobs(repo_root: Path, python_executable: str) -> Dict[str, ScraperJob]:
    ...
    jobs = [
        ...
        ScraperJob(
            ...
            command=[python_executable, "hibe/backend/run_scrapers.py"],
            cwd=cwd,
            expected_outputs=["hibe/grant_dashboard.db"],
        ),
        ScraperJob(
            ...
            command=[python_executable, "hibe/backend/run_scrapers.py", "--source", "eu_funding"],
            cwd=cwd,
            expected_outputs=["hibe/grant_dashboard.db"],
        ),
        ScraperJob(
            ...
            command=[python_executable, "hibe/backend/run_scrapers.py", "--source", "eu_affairs"],
            cwd=cwd,
            expected_outputs=["hibe/grant_dashboard.db"],
        ),
        ScraperJob(
            ...
            command=[python_executable, "hibe/backend/run_scrapers.py", "--source", "yatirima"],
            cwd=cwd,
            expected_outputs=["hibe/grant_dashboard.db"],
        ),
        ScraperJob(
